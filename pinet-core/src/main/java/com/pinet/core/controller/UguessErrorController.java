...
public class UguessErrorController implements ErrorController {
    ...
    public HttpResult error(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (obj != null && obj instanceof UguessException) {
            UguessException uguessException = (UguessException) obj;
    ...
    @ExceptionHandler(UguessException.class)
    public HttpResult handler(UguessException e) {
        log.error(e.getMessage(), e);
        return HttpResult.error(ApiErrorEnum.ERROR.getCode(), e.getMsg());
    }

    @ExceptionHandler(IllegalArgumentException.class)
    public HttpResult handlerArgument(IllegalArgumentException e) {
