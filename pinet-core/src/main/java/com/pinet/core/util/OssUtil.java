...
public class OssUtil {
    ...
    static {
        ...
        BUCKET_NAME = environment.getProperty("aliyun.oss.bucket_name");
        ACCESS_KEY_ID = environment.getProperty("aliyun.oss.access_key_id");
        ACCESS_KEY_SECRET = environment.getProperty("aliyun.oss.access_key_secret");
        FOLDER = environment.getProperty("aliyun.oss.dir");
    }
    ...
    public static String uploadFile(MultipartFile file){
        return uploadObject2OSS(getOSSClient(),file,BUCKET_NAME,FOLDER);
    }
