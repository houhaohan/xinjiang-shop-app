...
public class CodeGenerateUtil {
    ...
    private static String url = "jdbc:mysql://192.168.1.91:3306/xinjiang-shop?characterEncoding=UTF-8&useUnicode=true&useSSL=false&tinyInt1isBit=false";
//    private static String url = "jdbc:mysql://192.168.1.91:3306/xjs?characterEncoding=UTF-8&useUnicode=true&useSSL=false&tinyInt1isBit=false";
    ...
    private static String[] tables = {"community_pull_black"};
